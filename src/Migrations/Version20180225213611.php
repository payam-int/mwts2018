 ...
 */
class Version20180225213611 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE summary_article (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, article_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, file VARCHAR(255) NOT NULL COLLATE BINARY, paid BOOLEAN NOT NULL, reviewed BOOLEAN NOT NULL, accepted BOOLEAN NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_7DAAE07DA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_7DAAE07D7294869C FOREIGN KEY (article_id) REFERENCES article (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN national_code VARCHAR(255) NOT NULL DEFAULT \'0\' ');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__article AS SELECT id, user_id, summary_id, file, paid FROM article');
        $this->addSql('DROP TABLE article');
        $this->addSql('CREATE TABLE article (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, summary_id INTEGER DEFAULT NULL, file VARCHAR(255) NOT NULL, paid BOOLEAN DEFAULT \'FALSE\' NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO article (id, user_id, summary_id, file, paid) SELECT id, user_id, summary_id, file, paid FROM __temp__article');
        $this->addSql('DROP TABLE __temp__article');
        $this->addSql('CREATE INDEX IDX_23A0E66A76ED395 ON article (user_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_23A0E662AC2D45C ON article (summary_id)');
        ...
        $this->addSql('DROP TABLE summary_article');
        $this->addSql('CREATE TABLE summary_article (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, article_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL, file VARCHAR(255) NOT NULL, reviewed BOOLEAN DEFAULT \'FALSE\' NOT NULL, accepted BOOLEAN DEFAULT \'FALSE\' NOT NULL, paid BOOLEAN DEFAULT \'FALSE\' NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, full_name, phone_number, email, password, roles, paid FROM user');
        ...
        $this->addSql('INSERT INTO user (id, full_name, phone_number, email, password, roles, paid) SELECT id, full_name, phone_number, email, password, roles, paid FROM __temp__user');
