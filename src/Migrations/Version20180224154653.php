 ...
 */
class Version20180224154653 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE payment (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, reference_id VARCHAR(255) DEFAULT NULL COLLATE BINARY, price VARCHAR(255) NOT NULL COLLATE BINARY, state INTEGER NOT NULL, metadata CLOB NOT NULL --(DC2Type:json)
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE registration_type (id INTEGER NOT NULL, price VARCHAR(255) NOT NULL COLLATE BINARY, name VARCHAR(255) NOT NULL COLLATE BINARY, roles CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:simple_array)
        , need_verification BOOLEAN NOT NULL, description VARCHAR(255) NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        ...
        , paid BOOLEAN DEFAULT \'0\' NOT NULL, registration_type_id INTEGER DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO user (id, full_name, phone_number, email, password, roles, paid) SELECT id, full_name, phone_number, email, password, roles, paid FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
