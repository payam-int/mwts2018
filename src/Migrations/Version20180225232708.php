 ...
 */
class Version20180225232708 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        , online_payment_price VARCHAR(255) NOT NULL COLLATE BINARY, done BOOLEAN NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_6D28840DA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        , paid BOOLEAN DEFAULT \'0\' NOT NULL, national_code VARCHAR(255) NOT NULL COLLATE BINARY, first_name VARCHAR(255) NOT NULL DEFAULT \'\', lastname VARCHAR(255) NOT NULL DEFAULT \'\', PRIMARY KEY(id))');
        $this->addSql('INSERT INTO user (id, first_name, phone_number, email, password, roles, paid, national_code) SELECT id, full_name, phone_number, email, password, roles, paid, national_code FROM __temp__user');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__article AS SELECT id, user_id, summary_id, payment_id, file, paid FROM article');
        $this->addSql('DROP TABLE article');
        $this->addSql('CREATE TABLE article (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, summary_id INTEGER DEFAULT NULL, payment_id INTEGER DEFAULT NULL, file VARCHAR(255) NOT NULL, paid BOOLEAN DEFAULT \'FALSE\' NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO article (id, user_id, summary_id, payment_id, file, paid) SELECT id, user_id, summary_id, payment_id, file, paid FROM __temp__article');
        $this->addSql('DROP TABLE __temp__article');
        $this->addSql('CREATE INDEX IDX_23A0E66A76ED395 ON article (user_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_23A0E662AC2D45C ON article (summary_id)');
        ...
        $this->addSql('DROP TABLE discount');
        $this->addSql('CREATE TABLE discount (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, payment_id INTEGER DEFAULT NULL, price VARCHAR(255) NOT NULL, used BOOLEAN DEFAULT \'FALSE\' NOT NULL, PRIMARY KEY(id))');
        ...
        , done BOOLEAN DEFAULT \'FALSE\' NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('DROP TABLE summary_article');
        $this->addSql('CREATE TABLE summary_article (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, article_id INTEGER DEFAULT NULL, payment_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL, file VARCHAR(255) NOT NULL, reviewed BOOLEAN DEFAULT \'FALSE\' NOT NULL, accepted BOOLEAN DEFAULT \'FALSE\' NOT NULL, paid BOOLEAN DEFAULT \'FALSE\' NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_7DAAE07D4C3A3BB ON summary_article (payment_id)');
        $this->addSql('DROP INDEX UNIQ_8D93D649E7927C74');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, phone_number, national_code, email, password, roles, paid FROM user');
        $this->addSql('DROP TABLE user');
        ...
        , paid BOOLEAN DEFAULT \'0\' NOT NULL, full_name VARCHAR(255) NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO user (id, phone_number, national_code, email, password, roles, paid) SELECT id, phone_number, national_code, email, password, roles, paid FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
    }
}
