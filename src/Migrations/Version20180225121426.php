 ...
 */
class Version20180225121426 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__summary_article AS SELECT id, user_id, article_id, title, state, file, paid FROM summary_article');
        $this->addSql('DROP TABLE summary_article');
        $this->addSql('CREATE TABLE summary_article (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, article_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, state VARCHAR(255) DEFAULT NULL COLLATE BINARY, file VARCHAR(255) NOT NULL COLLATE BINARY, paid BOOLEAN NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_7DAAE07DA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_7DAAE07D7294869C FOREIGN KEY (article_id) REFERENCES article (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO summary_article (id, user_id, article_id, title, state, file, paid) SELECT id, user_id, article_id, title, state, file, paid FROM __temp__summary_article');
        ...
        $this->addSql('CREATE TABLE discount (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, payment_id INTEGER DEFAULT NULL, used BOOLEAN NOT NULL, price VARCHAR(255) NOT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_E1E0B40EA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_E1E0B40E4C3A3BB FOREIGN KEY (payment_id) REFERENCES payment (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        , online_payment_price VARCHAR(255) NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_6D28840DA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__summary_article AS SELECT id, user_id, article_id, title, state, file, paid FROM summary_article');
        $this->addSql('DROP TABLE summary_article');
        $this->addSql('CREATE TABLE summary_article (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, article_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL, state VARCHAR(255) DEFAULT NULL, file VARCHAR(255) NOT NULL, paid BOOLEAN DEFAULT \'FALSE\' NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO summary_article (id, user_id, article_id, title, state, file, paid) SELECT id, user_id, article_id, title, state, file, paid FROM __temp__summary_article');
        $this->addSql('DROP TABLE __temp__summary_article');
        $this->addSql('CREATE INDEX IDX_7DAAE07DA76ED395 ON summary_article (user_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_7DAAE07D7294869C ON summary_article (article_id)');
